...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.viewholder> {
    ...
    holder.plusItem.setOnClickListener(v -> managmentCart.plusNumberItem(list, position, (ChangeNumberItemsListener) () -> {
        notifyDataSetChanged();
        changeNumberItemsListener.change();
    }));

    holder.minusItem.setOnClickListener(v -> managmentCart.minusNumberItem(list, position, (ChangeNumberItemsListener) () -> {
        notifyDataSetChanged();
        changeNumberItemsListener.change();
    }));
    }
